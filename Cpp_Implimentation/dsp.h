...
std::complex<float> *turn_to_imag(float *data, uint8_t size);
std::complex<float> *fft(std::complex<float> *data, uint8_t size);
std::complex<float> *inverse_fft(std::complex<float> *data, uint8_t size);

void create_filter(filter *filter, enum filter_type type, uint8_t order, float Q, float freq);

// filters in freq domain
void low_pass_filter_freq(std::complex<float> *data, filter *filter, uint8_t size);
void high_pass_filter_freq(std::complex<float>, filter *filter, uint8_t size);
void band_pass_filter_freq(std::complex<float>, filter *filter, uint8_t size);
void band_stop_filter_freq(std::complex<float>, filter *filter, uint8_t size);
...
// misc utilities
float find_peak_to_peak(std::complex<float>, uint8_t size);
float find_fundamental_freq(std::complex<float> *data, uint8_t size);

void clip_signal(std::complex<float> *data, float upper_clip_limit, float lower_clip_limit, uint8_t size);
